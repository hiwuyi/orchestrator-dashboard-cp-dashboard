<template>
  <el-row class="footer">
    ...
    <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="m flex-row flex-end align-end">
      <div class="flex-row flex-end">
        <div class="media-list flex-row flex-end">
...
export default defineComponent({
  setup () {
    ...
    const emailAddress = ref(process.env.VUE_APP_BASE_EMAIL)
