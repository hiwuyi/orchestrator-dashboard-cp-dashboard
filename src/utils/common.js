  ...
  switch (chainId) {
    case 20241133:
      text = {
        ...
        rpcUrls: [import.meta.env.VITE_API_ATOMURL],
        blockExplorerUrls: [import.meta.env.VITE_API_ATOMBLOCKURL]
      }
      break
    // case 80001:
    //   text = {
    ...
    //       decimals: 18
    //     },
    //     rpcUrls: [import.meta.env.VITE_API_MUMBAIRPCURL],
    //     blockExplorerUrls: [import.meta.env.VITE_API_MUMBAIPAYMENTURL]
    //   }
    //   break
    // case 97:
    //   text = {
    ...
    //     blockExplorerUrls: [import.meta.env.VITE_API_BSCTESTNETBLOCKURL]
    //   }
    //   break
    // case 137:
    //   text = {
    ...
    //     blockExplorerUrls: [import.meta.env.VITE_API_POLYGONBLOCKURL]
    //   }
    //   break
  }
  try {
...
async function sign (nonce) {
  ...
  const local = import.meta.env.VITE_API_DOMAINNAME
...
async function performSignin (sig) {
  try {
    ...
    const response = await sendRequest(`${import.meta.env.VITE_API_BASEAPI}login`, 'post', reqOpts)
...
async function getUnit (id) {
  ...
  switch (id) {
    ...
    case 2024:
      unit = 'sETH'
      name = 'Saturn Testnet ' 
      url = `${import.meta.env.VITE_API_SATURNBLOCKURL}/address/`
      url_tx = `${import.meta.env.VITE_API_SATURNBLOCKURL}/tx/`
      break
    case 20241133:
      unit = 'sETH'
      name = 'Swan Proxima Chain '
      url = `${import.meta.env.VITE_API_ATOMBLOCKURL}/address/`
      url_tx = `${import.meta.env.VITE_API_ATOMBLOCKURL}/tx/`
      break
    default:
      unit = '-'
      name = `Chain ${id}`
